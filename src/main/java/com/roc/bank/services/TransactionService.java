...
public class TransactionService {
	...
	public Transaction createTransaction( int tran_acct_id, int tran_bank_id, String tran_type, int tran_xfer_from_cust_id, int tran_xfer_from_acct_id, int tran_xfer_to_cust_id, int tran_xfer_to_acct_id, float tran_amt ) {
		Transaction transaction = new Transaction();
		transaction = Transaction.initializeTransaction( tran_acct_id, tran_bank_id, tran_type, tran_xfer_from_cust_id, tran_xfer_from_acct_id, tran_xfer_to_cust_id, tran_xfer_to_acct_id, tran_amt );
		
		try (Connection connection = ConnectionUtil.getConnection()) {
// transaction control in calling methods			
